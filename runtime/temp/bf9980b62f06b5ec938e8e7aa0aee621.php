<?php /*a:1:{s:60:"E:\xiao\smallprogram\application/admin/view\login\index.html";i:1517135999;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="signinpanel">
    ...
    <div class="signup-footer">
        <div class="pull-left" style="color:#fff">
            &copy; 2018 Angular后台管理系统 All Rights Reserved. 
        </div>
    </div>
</div>
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#username').val())){           
                artisan.error('请输入登录用户名');
                return false;
            }
     
            if( '' == $.trim($('#password').val())){
                artisan.error('请输入登录密码');
                return false;
            }

            if (<?php echo htmlentities($verify_type); ?> == 0) {
                if( false == check_result){
                    artisan.error('请拖动滑块到最右边');
                    return false;
                }
            }         
        ...
        function complete(data){
            if(data.code==1){
                artisan.success(data.msg,data.url);
            }else{ 
                artisan.error(data.msg);
