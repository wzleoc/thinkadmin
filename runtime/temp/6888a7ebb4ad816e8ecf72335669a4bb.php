<?php /*a:3:{s:60:"E:\xiao\smallprogram\application/admin/view\index\index.html";i:1518251361;s:62:"E:\xiao\smallprogram\application/admin/view\public\header.html";i:1518183050;s:62:"E:\xiao\smallprogram\application/admin/view\public\footer.html";i:1518183083;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-sm-6">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <p><i class="fa fa-sitemap"></i> 框架版本：ThinkPHP5.1
                        </p>
                        <p><i class="fa fa-windows"></i> 服务环境：<?php echo htmlentities($info['web_server']); ?>
                        </p>
                        <p><i class="fa fa-warning"></i> 上传附件限制：<?php echo htmlentities($info['onload']); ?>
                        </p>
                        <p><i class="fa fa-credit-card"></i> PHP 版本：<?php echo htmlentities($info['phpversion']); ?>
                        </p>
                    </div>
                </div>
            </div>
